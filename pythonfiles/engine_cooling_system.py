...
driver.get('https://www.onlinecarparts.co.uk/spare-parts/engine-cooling-system-group.html')
...
workbook = xlsxwriter.Workbook('EnginecoolingSystem SubCategory.xlsx')
