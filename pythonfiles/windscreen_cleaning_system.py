...
driver.get('https://www.onlinecarparts.co.uk/spare-parts/windscreen-cleaning-system-group.html')
...
workbook = xlsxwriter.Workbook('WindscreenCleaningSystem SubCategory.xlsx')
