...
driver.get('https://www.onlinecarparts.co.uk/spare-parts/gaskets-sealing-rings-group.html')
...
workbook = xlsxwriter.Workbook('GasketsSealingRings SubCategory.xlsx')
